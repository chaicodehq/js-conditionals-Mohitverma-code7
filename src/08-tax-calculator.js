...
export function calculateTax(income) {
  ...
  if (income > 10000) {
    const taxDeduct = Math.min(income,30000)-10000;
    taxAmount += taxDeduct * 0.1 ;
  }
  if (income > 30000) {
    const taxDeduct = Math.min(income,70000)-30000;
    taxAmount += taxDeduct * 0.2 ;
  }
  if (income > 70000) {
    const taxDeduct = income - 70000 ;
    taxAmount += taxDeduct * 0.3 ;
  }
